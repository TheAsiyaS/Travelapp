...
class Cheep extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Schedule actions to be performed after the build phase
    ...
    return Scaffold(
      body: Column(
        ...
        children: [
          BlocBuilder<HotelPlaceBloc, HotelPlaceState>(
                                    ...
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState ==
                                        ...
                                        if (currentuserdata.value.uid != null) {
                                          ...
                                          // Schedule state updates after the build phase
                                          WidgetsBinding.instance
                                              .addPostFrameCallback((_) {
                                            likes.value =
                                                List.from(likedPostNumericIds);
                                          });
                                        }

                                        // Use ValueListenableBuilder to listen for changes in likes
